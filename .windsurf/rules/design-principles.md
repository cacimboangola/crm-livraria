...
- [ ] Fixed header with logo + clear navigation  
- [ ] Responsive menu (hamburger for mobile)  
- [ ] Footer with institutional links, contact, social media  
- [ ] Breadcrumbs on internal pages  
- [ ] Organized heading structure (H1, H2, H3)  

### 2. Content & Messaging
- [ ] Clear main message (who you are / what you do)  
- [ ] Call-to-Actions (CTAs) visible and consistent  
- [ ] Concise, readable copy without grammar errors  
- [ ] Multilingual support if required (with language switcher)  
- [ ] Regularly updated content (no broken links / outdated info)  

### 3. User Experience (UX/UI)
- [ ] Consistent layout (spacing, grids, typography)  
- [ ] High-quality and relevant icons & images  
- [ ] Microinteractions on buttons/links  
- [ ] Simple, clear forms with real-time validation  
- [ ] Visible states for errors, success, and loading  

### 4. Performance & Accessibility
- [ ] Site loads in < 2s on 4G  
- [ ] Lazy loading for heavy images/videos  
...
- [ ] Backups and uptime monitoring in place  
...
- [ ] Google Analytics / GA4 or alternative integrated  

### 7. Devices & Browsers
- [ ] Tested on desktop (≥1440px), tablet (~768px), and mobile (~375px)  
- [ ] Compatible with Chrome, Safari, Firefox, and Edge  
- [ ] No unwanted horizontal scrolling  
- [ ] Buttons and inputs large enough for touch on mobile  

---

---
- [ ] In the end use the @design-review-agent.md 